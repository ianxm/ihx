...
Accessing this field requires a system platform
: when targeting javascript, be sure to add the "hxnekojs" library.

Cannot use Void as a value
: include the semicolon at the end of any line that doesn't return a value.
